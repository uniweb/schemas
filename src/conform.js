 ...
 * the thing a list shows. That makes it the answer to "which fields belong in a
 * collection's list payload, and which are wanted only when one record is the
 * focus?" — a question a site otherwise answers by hand, per collection, in build
 * config, with nothing checking it against the shape it describes.
 *
